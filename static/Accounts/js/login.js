...
async function submitForm(e, form){
  ...
  const response = await fetchService.performPostHttpRequest("https://auth.pyroneon.net:8443/api/authenticate", headers, jsonFormData);
  ...
  if(statusType === "2"){
    ...
    setTimeout(() => {
      window.location.href = "/accounts/users/dashboard";}, 1000);
  }
  // Client error
